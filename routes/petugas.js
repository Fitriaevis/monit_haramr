...
// Route untuk halaman detail pelanggan berdasarkan id_pelanggan
...
// Endpoint untuk mengambil data pelanggan berdasarkan id_pel
...
router.post("/store", upload.fields([
  ...
  try {
      let {
        ...
        longitude, latitude, lwbp, wbp, bp, total, kvarh, merk_cb_mccb, tipe_cb_mccb, merk_ct, penggantian_modem, no_meter_update, 
...
router.post("/update/:id", upload.fields([
  ...
  try {
    ...
    res.redirect("/petugas/edit/" + req.params.id);
  }
});
